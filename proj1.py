...
def main():
    ...
    transition_mappings=dict([("empty",st("empty",0)),("emptya",st("a",0)),("emptyb",st("b",0)),("emptyc",st("c",0))
        ...
        ,("aaaa",st("reject",0)),("aaab",st("reject",0)),("aaac",st("reject",0)),("aaba",st("reject",1))
        ,("aabb",st("reject",1)),("aabc",st("abc",1)),("aaca",st("reject",1)),("aacb",st("acb",1)),("aacc",st("reject",1))
        ,("abaa",st("reject",0)),("abab",st("reject",0)),("abac",st("bac",1)),("abba",st("reject",1)),("abbb",st("reject",1))
        ...
        ,("cbca",st("bca",1)),("cbcb",st("reject",0)),("cbcc",st("reject",1)),("ccaa",st("reject",0)),("ccab",st("cab",1))
    ...
    #   if tm 
    #print(list(states)[0])
    #print([[state for x in ['a','b','c'] if transition_mappings[state+x].name ==state] for state in list(states)])
    #print(transition_mappings["caa"].name)
